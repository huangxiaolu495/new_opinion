<template>
  <div>
    ...
    <div class="queryCondition-top mr">
      <div class="queryCondition-title">关联公司舆情监控</div>
      <div class="middle clearFloat">
        <div class="floatLeft mt20">
          <input type="text" class="input" v-model="queryCondition.fund_code" placeholder="请输入公司名称、人员、品牌名称等关键词">
        </div>
        <!-- 查询按钮 -->
        <div class="queryBtn">
...
export default {
  data() {
    return {
      ...
      sidebarData: [
        { title: '公司信息查询', path: '/monitor/companyWarning' },
        { title: '我已关注的公司舆情', path: '/monitor/concerncompany' },
      ],
      dataList: [],
    }
  },
